...
# Load order: ENV_FILE env var > DDOS_X_LOADER.env > .env
...
<title>DDOS_X_LOADER Panel – Login</title>
...
<div class="ft">© 2025 <span>DDOS_X_LOADER</span> Premium Panel</div>
</div>
</div>
<script>
(function(){
